  ...
  return (
    <>
      <div
        ...
        className="flex justify-around lg:justify-evenly gap-10 fixed w-full text-white items-center py-5 ease-in-out duration-300 shadow-md"
      >
      ...
      <div className="lg:hidden transition relative">
        <div
          className={`flex flex-col gap-1 bg-white text-black absolute top-24 w-[200px] right-10 z-0 rounded-md p-3 ${
